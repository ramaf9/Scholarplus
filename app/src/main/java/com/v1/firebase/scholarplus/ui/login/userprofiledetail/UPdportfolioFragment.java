...
import com.v1.firebase.scholarplus.ui.login.profiledetail.DetailPdportfolioActivity;
...
public class UPdportfolioFragment extends Fragment {
    ...
    public static UPdportfolioFragment newInstance(String uid) {
        UPdportfolioFragment fragment = new UPdportfolioFragment();
